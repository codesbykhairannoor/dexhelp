...
MIN_ENTRY_SCORE = 65  # Realistis untuk 0-minute token (max score tanpa socials/paid ~60)
...
MIN_VOL_5M = 1000      # Diturunkan: Token 0-menit awal belum punya volume tinggi
