...
MIN_ENTRY_SCORE = 81  # Lowered: Previous high score requirement filtered out viable entries; allow strong signals with slight variance
...
MIN_VOL_5M = 55000     # Reduced: Focus on organic volume buildup, not artificial hype walls
MIN_TRADES_5M = 25     # Slight loosen: Ensure sufficient trader consensus without overfitting to noise
